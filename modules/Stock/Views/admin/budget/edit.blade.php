...
<div class="col-md-9">
    <div class="panel">
        ...
        <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="date" name="start_date" placeholder="" class="form-control" value="{{$row->start_date}}">
                </div>
                <div class="form-group">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label><input type="checkbox" name="enable_composition" @if(!empty($row->product_composition)) checked @endif value="1"> {{__('Adicionar Fornecedores')}} </label>
            </div>
    ...
    <div class="panel">
        ...
        <div class="panel-body">
                ...
                <div class="form-group">
                    <label><input type="checkbox" name="enable_product_composition" @if(!empty($row->product_composition)) checked @endif value="1"> {{__('Adicionar Produtos')}} </label>
                </div>
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="">
                    <textarea name="supplier_content" class="d-none has-ckeditor" cols="30" rows="10">{{$row->supplier_content}}</textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="control-label">{{__("Esta observação é de uso interno, portanto não será visível para o fornecedor.")}}</label>
                <div class="">
                    <textarea name="internal_content" class="d-none has-ckeditor" cols="30" rows="10">{{$row->internal_content}}</textarea>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-md-3">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <div class="form-group">
                <input type="checkbox" name="send_adm_mail" @if($row->send_adm_mail) checked @endif value="1"> {{__("Enviar Email para ADM")}}
            </div>
            <div class="form-group">
                <input type="checkbox" name="send_stock_mail" @if($row->send_stock_mail) checked @endif value="1"> {{__("Enviar Email para Estoque")}}
            </div>
            <div class="form-group">
                <input type="checkbox" name="send_suppliers_mail" @if($row->send_suppliers_mail) checked @endif value="1"> {{__("Enviar E-mail para todos os Fornecedores")}}
            </div>
            <div class="form-group">
                <input type="checkbox" name="send_manager_mail" @if($row->send_manager_mail) checked @endif value="1"> {{__("Enviar E-mail Gerência")}}
            </div>
            <div class="form-group">
                <input type="checkbox" name="is_purchase" @if($row->is_purchase) checked @endif value="1"> {{__("Compra")}}
            </div>
        </div>
    </div>
</div>
