                            ...
                            <div class="col-md-4">
                                ...
                                <div class="p-2 py-2 bg-white">
                                    <div class="p-2 bg-white">
                                        ...
                                        <span class="mt-5 balance value_paid_s"></span>
                                    </div>
                                </div>
                                <div class="p-3 bg-white">
                                    <h6 class="account">Valor Total a Pagar</h6>
                                    <span class="mt-5 restante value_pend_s"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-0" id="printThisPayment">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="p-2 py-2 bg-white">
                                        <div class="p-2 bg-white">
                                            <h6 class="account">Valor Total Pago</h6>
                                            <span class="mt-5 balance value_paid_s_add"></span>
                                        </div>
                                    </div>
                                    <div class="p-3 bg-white">
                                        <h6 class="account">Valor Total Restante</h6>
                                        <div>
                                            <span class="mt-5 restante value_pend_s_add">
                                            </span>
                                        </div>
                                    </div>
                                </div>
