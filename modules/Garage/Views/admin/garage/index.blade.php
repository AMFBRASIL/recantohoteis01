...
@section('admin-form-content')
    <div class="form-group">
        <label>{{__("Garagem")}}</label>
        <input type="text" value="{{isset($row) ? $row->name : ''}}" placeholder="{{__("")}}" name="name" class="form-control" style="text-transform: uppercase">
    </div>
    <div class="form-group">
        <label>{{__("Bloco da Garagem")}}</label>
        <select
    ...
    <div class="form-group">
        <label>{{__("Andar da Garagem")}}</label>
