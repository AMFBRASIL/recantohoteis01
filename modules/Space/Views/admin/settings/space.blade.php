            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <input type="text" name="space_page_search_title"
                               value="{{setting_item_with_lang('space_page_search_title',request()->query('lang'))}}"
                               class="form-control">
                    </div>
                </div>
                @if(is_default_lang())
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="space_layout_search" class="form-control">
                                <option
                                    value="normal" {{ ($settings['space_layout_search'] ?? '') == 'normal' ? 'selected' : ''  }}>{{__("Normal Layout")}}</option>
                                <option
                                    value="map" {{($settings['space_layout_search'] ?? '') == 'map' ? 'selected' : ''  }}>{{__('Map Layout')}}</option>
                            </select>
                        </div>
                    </div>
                @endif
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <select name="space_layout_map_option" class="form-control">
                            <option
                                {{ (setting_item_with_lang('space_layout_map_option',request()->query('lang')) ?? '') == 'map_left' ? 'selected' : '' }} value="map_left">{{__('Map Left')}}</option>
                            <option
                                {{ (setting_item_with_lang('space_layout_map_option',request()->query('lang')) ?? '') == 'map_right' ? 'selected' : ''  }} value="map_right">{{__("Map Right")}}</option>
                        </select>
                    </div>
                </div>
                @if(is_default_lang())
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <input type="number" min="1" name="space_page_limit_item"
                                   placeholder="{{ __("Default: 9") }}"
                                   value="{{setting_item_with_lang('space_page_limit_item',request()->query('lang'), 9)}}"
                                   class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="space_location_search_style" class="form-control">
                                <option
                                    {{ ($settings['space_location_search_style'] ?? '') == 'normal' ? 'selected' : ''  }}      value="normal">{{__("Normal")}}</option>
                                <option
                                    {{ ($settings['space_location_search_style'] ?? '') == 'autocomplete' ? 'selected' : '' }} value="autocomplete">{{__('Autocomplete from locations')}}</option>
                                <option
                                    {{ ($settings['space_location_search_style'] ?? '') == 'autocompletePlace' ? 'selected' : '' }} value="autocompletePlace">{{__('Autocomplete from Gmap Place')}}</option>
                            </select>
                        </div>
                    </div>
                @endif
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="seo_1">
                            <div class="form-group">
                                ...
                                <input type="text" name="space_page_list_seo_title" class="form-control"
                                       placeholder="{{__("Enter title...")}}"
                                       value="{{ setting_item_with_lang('space_page_list_seo_title',request()->query('lang'))}}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Seo Description")}}</label>
                                <input type="text" name="space_page_list_seo_desc" class="form-control"
                                       placeholder="{{__("Enter description...")}}"
                                       value="{{setting_item_with_lang('space_page_list_seo_desc',request()->query('lang'))}}">
                            </div>
                            @if(is_default_lang())
                        ...
                        <div class="tab-pane" id="seo_2">
                            <div class="form-group">
                                ...
                                <input type="text" name="space_page_list_seo_share[facebook][title]"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="space_page_list_seo_share[facebook][desc]" class="form-control"
                                       placeholder="{{__("Enter description...")}}"
                        ...
                        <div class="tab-pane" id="seo_3">
                            <div class="form-group">
                                ...
                                <input type="text" name="space_page_list_seo_share[twitter][title]" class="form-control"
                                       placeholder="{{__("Enter title...")}}"
                                       value="{{$seo_share['twitter']['title'] ?? "" }}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Twitter Description")}}</label>
                                <input type="text" name="space_page_list_seo_share[twitter][desc]" class="form-control"
                                       placeholder="{{__("Enter description...")}}"
                                       value="{{$seo_share['twitter']['title'] ?? "" }}">
                            </div>
                            @if(is_default_lang())
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_enable_review" value="1"
                                          @if(!empty($settings['space_enable_review'])) checked @endif /> {{__("Yes, please enable it")}}
                            </label>
                            <br>
                    ...
                    <div class="form-group" data-condition="space_enable_review:is(1)">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_enable_review_after_booking" value="1"
                                          @if(!empty($settings['space_enable_review_after_booking'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
                            <small
                    ...
                    <div class="form-group"
                         data-condition="space_enable_review:is(1),space_enable_review_after_booking:is(1)">
                                ...
                                @foreach($status as $item)
                                    <div class="col-md-4">
                                        <label><input type="checkbox"
                                                      name="space_allow_review_after_making_completed_booking[]"
                    ...
                    <div class="form-group" data-condition="space_enable_review:is(1)">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_review_approved" value="1"
                                          @if(!empty($settings['space_review_approved'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
                            <small
                    ...
                    <div class="form-group" data-condition="space_enable_review:is(1)">
                        ...
                        <div class="form-controls">
                            <input type="number" class="form-control" name="space_review_number_per_page"
                                   value="{{ $settings['space_review_number_per_page'] ?? 5 }}"/>
                            ...
                            <div class="form-group-item">
                                ...
                                <div class="g-items">
                                    ...
                                    @foreach($social_share as $key=>$item)
                                        <div class="item" data-number="{{$key}}">
                                            <div class="row">
                                                <div class="col-md-11">
                                                    <input type="text" name="space_review_stats[{{$key}}][title]"
                                ...
                                <div class="g-more hide">
                                    <div class="item" data-number="__number__">
                                        <div class="row">
                                            <div class="col-md-11">
                                                <input type="text" __name__="space_review_stats[__number__][title]"
                                        ...
                                        <div class="row">
                                                ...
                                                @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                    @foreach($languages as $language)
                                                        ...
                                                        <div class="g-lang">
                                                            ...
                                                            <input type="text"
                                                                   name="space_booking_buyer_fees[{{$key}}][name{{$key_lang}}]"
                                                                   class="form-control"
                                                                   value="{{$buyer_fee['name'.$key_lang] ?? ''}}"
                                                                   placeholder="{{__('Fee name')}}">
                                                            <input type="text"
                                                                   name="space_booking_buyer_fees[{{$key}}][desc{{$key_lang}}]"
                                                                   class="form-control"
                                                    ...
                                                    @endforeach
                                                @else
                                                    <input type="text" name="space_booking_buyer_fees[{{$key}}][name]"
                                                           class="form-control" value="{{$buyer_fee['name'] ?? ''}}"
                                                           placeholder="{{__('Fee name')}}">
                                                    <input type="text" name="space_booking_buyer_fees[{{$key}}][desc]"
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" min="0" step="0.1"
                                                       name="space_booking_buyer_fees[{{$key}}][price]"
                                                       class="form-control" value="{{$buyer_fee['price']}}">
                                                <select name="space_booking_buyer_fees[{{$key}}][unit]"
                                                        class="form-control">
                                            ...
                                            <div class="col-md-3">
                                                <select name="space_booking_buyer_fees[{{$key}}][type]"
                                                ...
                                                <label>
                                                    <input type="checkbox" min="0"
                                                           name="space_booking_buyer_fees[{{$key}}][per_person]"
                                                           value="on"
                        ...
                        <div class="g-more hide">
                            <div class="item" data-number="__number__">
                                <div class="row">
                                        ...
                                        @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                            @foreach($languages as $language)
                                                ...
                                                <div class="g-lang">
                                                    <div class="title-lang">{{$language->name}}</div>
                                                    <input type="text"
                                                           __name__="space_booking_buyer_fees[__number__][name{{$key}}]"
                                                           class="form-control" value=""
                                                           placeholder="{{__('Fee name')}}">
                                                    <input type="text"
                                                           __name__="space_booking_buyer_fees[__number__][desc{{$key}}]"
                                                           class="form-control" value=""
                                                           placeholder="{{__('Fee desc')}}">
                                                </div>
                                            ...
                                            @endforeach
                                        @else
                                            <input type="text" __name__="space_booking_buyer_fees[__number__][name]"
                                                   class="form-control" value="" placeholder="{{__('Fee name')}}">
                                            <input type="text" __name__="space_booking_buyer_fees[__number__][desc]"
                                                   class="form-control" value="" placeholder="{{__('Fee desc')}}">
                                        @endif
                                    </div>
                                    <div class="col-md-3">
                                        <input type="number" min="0" step="0.1"
                                               __name__="space_booking_buyer_fees[__number__][price]"
                                               class="form-control" value="">
                                        <select __name__="space_booking_buyer_fees[__number__][unit]"
                                                class="form-control">
                                    ...
                                    <div class="col-md-3">
                                        <select __name__="space_booking_buyer_fees[__number__][type]"
                                                class="form-control d-none">
                                            <option value="one_time">{{__("One-time")}}</option>
                                        </select>
                                        <label>
                                            <input type="checkbox" min="0"
                                                   __name__="space_booking_buyer_fees[__number__][per_person]"
                                                   value="on">
                                            {{__("Price per person")}}
                                        </label>
                                    </div>
            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_vendor_create_service_must_approved_by_admin"
                                          value="1"
                                          @if(!empty($settings['space_vendor_create_service_must_approved_by_admin'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
                            <small
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_allow_vendor_can_change_their_booking_status"
                                          value="1"
                                          @if(!empty($settings['space_allow_vendor_can_change_their_booking_status'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
                            <small
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_allow_vendor_can_change_paid_amount" value="1"
                                          @if(!empty($settings['space_allow_vendor_can_change_paid_amount'])) checked @endif /> {{__("Yes please")}}
                            </label>
                            <br>
                            <small
        ...
        <div class="col-sm-8">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_deposit_enable" value="1"
                                          @if(setting_item('space_deposit_enable')) checked @endif > {{__('Yes, please enable it')}}
                            </label>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        <input type="number" name="space_deposit_amount" class="form-control" step="0.1"
                                               value="{{old('space_deposit_amount',setting_item('space_deposit_amount'))}}">
                                        <select name="space_deposit_type" class="form-control">
                                            <option value="fixed">{{__("Fixed")}}</option>
                                            <option
                                                @if(old('space_deposit_type',setting_item('space_deposit_type')) == 'percent') selected
                                                @endif value="percent">{{__("Percent")}}</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <select name="space_deposit_fomular" class="form-control">
                                        <option
                                            value="default" {{($settings['space_deposit_fomular'] ?? '') == 'default' ? 'selected' : ''  }}>{{__('Default')}}</option>
                                        <option
                                            value="deposit_and_fee" {{ ($settings['space_deposit_fomular'] ?? '') == 'deposit_and_fee' ? 'selected' : ''  }}>{{__("Deposit amount + Buyer free")}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-sm-8">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_disable" value="1"
                                          @if(setting_item('space_disable')) checked @endif > {{__('Yes, please disable it')}}
                            </label>
                        </div>
                    </div>
                </div>
